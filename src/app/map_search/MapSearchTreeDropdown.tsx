...
interface MapSearchTreeDropdownProps {
  nodes: Node[];
  buttonLabel?: string;
...
const MapSearchTreeDropdown: React.FC<MapSearchTreeDropdownProps> = ({
  nodes,
  ...
  return (
    <div
      ...
      className="w-full min-w-[200px] max-w-[min(400px,100vw)] flex-1 min-h-0 flex flex-col border border-border bg-card text-card-foreground shadow-sm overflow-hidden"
    >
      ...
      <div className="min-w-0 flex-1 overflow-auto p-2 min-h-[120px]">
        {isLoading ? (
          ...
          nodes.map((node, index) => {
            ...
            const selectedCountForParent = parentSelection?.child.length ?? 0;
              ...
              <div key={node.id} className="w-full min-w-0">
                ...
                <div className="mb-2 w-full min-w-0">
                  ...
                  <div
                    ...
                    aria-selected={selectedCountForParent > 0}
                    tabIndex={0}
                  ...
                  >
                    <div className="flex items-center space-x-2 min-w-0 flex-1">
                      ...
                      {selectedCountForParent > 0 ? (
                        <span className="text-xs text-primary font-medium shrink-0">
                          · {selectedCountForParent} selected
                        </span>
                      ) : null}
                    </div>
...
export default MapSearchTreeDropdown;
